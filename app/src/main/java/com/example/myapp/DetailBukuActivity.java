...
public class DetailBukuActivity extends AppCompatActivity {
    ...
    public static final String URLsKoleksijurnal = "http://192.168.43.183/apiperpus/public/api/koleksibuku";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jjudul = (TextView) findViewById(R.id.judul_buku_detail);
        jpengarang = (TextView) findViewById(R.id.pengarang_buku_detail);
        jtahunterbit = (TextView) findViewById(R.id.tahun_terbit_buku_detail);
