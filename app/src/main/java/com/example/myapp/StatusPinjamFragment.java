...
//        });
        ...
        mAdapter    = new AdabterStatusPinjam(getContext(),mRecyclerViewItems,this);
        QUEUE = Volley.newRequestQueue(getContext());

        User user = SharedPrefmanager.getInstance(getContext()).getUser();
        URLHTTP = getResources().getString(R.string.urlpinjamsemua)+'/'+user.getId();
        httpGET(URLHTTP);
    ...
    public void parsingData(String jsonData)
    {
        try {
            ...
            for (int i = 0; i < obj.length(); i++) {
                ...
                ModelStatusPinjam modelStatusPinjam = new ModelStatusPinjam(id, judul, pengarang, tahun_terbit, urlimages, urlpdf);
