...
public class StatusKembaliAdminFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter    = new AdabterStatusPengembalianAdmin(getContext(),mRecyclerViewItems,this);
        QUEUE = Volley.newRequestQueue(getContext());
        URLHTTP = getResources().getString(R.string.urllistsemuapengembalian);
        httpGET(URLHTTP);
    ...
    public void parsingData(String jsonData)
    {
        try {
            ...
            for (int i = 0; i < obj.length(); i++) {
                ...
                ModelAdminStatusKembali modelAdminStatusKembali = new ModelAdminStatusKembali(id,id_user,judul,pengarang,tahun_terbit,urlimages,urlpdf,status_buku_jurnal,nama,nim,prodi,created_at);
