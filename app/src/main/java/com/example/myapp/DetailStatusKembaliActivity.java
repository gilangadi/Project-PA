...
public class DetailStatusKembaliActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jjudul = (TextView) findViewById(R.id.judul_detail_status_pengguna_kembali);
        jpengarang = (TextView) findViewById(R.id.pengarang_detail_status_pengguna_kembali);
        jtahunterbit = (TextView) findViewById(R.id.tahun_terbit_detail_status_pengguna_kembali);
