...
public class DetailKoleksiBukuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jjudulk = (TextView) findViewById(R.id.judul_detail_koleksi_buku);
        jpengarangk = (TextView) findViewById(R.id.pengarang_detail_koleksi_buku);
        jtahunterbitk = (TextView) findViewById(R.id.tahun_terbit_detail_koleksi_buku);
        jimgk = (ImageView) findViewById(R.id.image_detail_koleksi_buku);
